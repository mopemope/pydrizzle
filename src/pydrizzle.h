...
#define MODULE_NAME "_pydrizzle"

extern drizzle_st *drizzle;

#define WAIT_READ 1
#define WAIT_WRITE 2
#define WAIT_READWRITE (WAIT_READ | WAIT_WRITE)

int wait_connect(drizzle_con_st *con);

int io_wait(drizzle_con_st *con, drizzle_return_t ret);
